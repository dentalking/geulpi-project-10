...
export const Logo: React.FC<LogoProps> = ({ 
  ...
  // 테마 색상을 사용하거나 props로 전달된 색상 사용
  const logoColor = color || 'currentColor';
  ...
  return (
    ...
    >
      {/* 메인 사각형 (캘린더 추상화) */}
      <rect x="50" y="50" width="100" height="100" fill="none" stroke="currentColor" strokeWidth="3" rx="8"/>
      
      {/* 상단 바 */}
      <rect x="50" y="50" width="100" height="25" fill="currentColor" rx="8"/>
      ...
      {/* AI 인디케이터 (중앙 점) */}
      <circle cx="100" cy="112" r="8" fill="currentColor"/>
      
      {/* 선택적 그리드 */}
      <g opacity="0.3">
        <line x1="50" y1="112" x2="150" y2="112" stroke="currentColor" strokeWidth="2"/>
        <line x1="100" y1="75" x2="100" y2="150" stroke="currentColor" strokeWidth="2"/>
      </g>
    </svg>
  );
};
